...
export default function Footer() {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="text-white mt-2 text-center md:text-center"style={{ marginTop: '10px', textShadow: "5px 5px 5px #2b2 "}}> For Movies, TV Show & Sports live.</p>
  ...
  <div className="bg-black">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Watch Online Movies™ —
        <a href="https://twitter.com/MxplayerMovies" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">For Movies, TV Show & Sports live. All rights reserved.</a>
      </p>
