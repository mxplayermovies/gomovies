  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: `Watch Online Movies | ${movie.name} for free. Where you can find movies of your interest in full HD quality updated on a daily basis. Watch Now or Download Now to Watch Later!`,
        image: movie.image,
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name='description'
          content='Watch Online Movies™ We offer streaming movies in genres like Action, Horror, Sci-Fi, Crime and Comedy. Watch now !!!'
        />
