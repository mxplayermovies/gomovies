...
const HomePage = () => {
  ...
  const shareMessage =
    'Watch Now !!! Watch Online Movies™ - For movie, TV Show & Sports!'
    ...
    <div className='w-full bg-black'>
      ...
      <div className='container mx-auto'>
        <Head>
          <title>
            {' '}
            Watch Online Movies™ - For Movie, TV Show & Sports Live.{' '}
          </title>
          <link
            rel='sitemap'
          ...
          <meta
            property='og:title'
            content='Watch Online Movies™ - For movie, TV Show & Sports Live.'
          />
          <meta
        ...
        <main className='max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          ...
          {/* <p
            ...
            style={{ color: '#40D7BC', textShadow: '5px 5px 2px #000' }}
          >
            " Watch Online Movies™ - For Movie, TV Show & Sports Live." is a
