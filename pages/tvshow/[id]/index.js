...
const tvshowDetail = ({ tvshow }) => {
  ...
  const shareMessage = 'Watch Now !!! Watch Online Movies™ - For Movies, TV Show & Sports Live.!';
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        author: {
          '@id':
            'https://watchonlinemovies.vercel.appauthor/watchtvshowsonline/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
  ...
  return (
    <div>
      ...
      >
          ...
          >
            Watch Online Movies™ - For Movies, TV Show & Sports Live..  </h2>
