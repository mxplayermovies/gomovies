...
const tvshowDetail = ({ tvshow }) => {
  ...
  const shareMessage =
    'Watch Now !!! Watch Online Movies™ - For Movies, TV Show & Sports Live.!'
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'Person',
        '@id': 'https://watchonlinemovies.vercel.appauthor/watchtvshowsonline/',
        name: 'Dr Trailer',
        url: 'https://watchonlinemovies.vercel.appauthor/watchtvshowsonline/',
        image: {
          '@type': 'ImageObject',
  ...
  const ldJsonData = JSON.stringify({
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://watchonlinemovies.vercel.appog_image.jpg'
      }
    },
    additionalProperty: {
      '@type': 'PropertyValue',
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:description'
          content=' Watch Online Movies, TV shows & Sports online on any device. We offer streaming on any Platform. Watch now !!!'
        />
      ...
      >
        ...
        {/* <p
          ...
          style={{ color: '#40D7BC', textShadow: '5px 5px 2px #000' }}
        >
          "Watch Online Movies™ - For Movies, Tv Shows & Sports Live" is a
          ...
          tailored to their preferences. Overall, "Watch Online Movies™ - For
              ...
              ></div> */}
                ...
                >
                  <iframe
                    ...
                    ref={audioIframeRef}
                    id='audioIframe'
                    src={`https://watchonlinemovies.vercel.app/tvshow/${tvshow.id}/video`}
                    // width='100%'
                    // height='100%'
                    allowFullScreen
