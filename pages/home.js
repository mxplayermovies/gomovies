...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://watchonlinemovies.vercel.app/movies/',
  headline: 'movies Section | Watch Online Movies™',
  url: 'https://watchonlinemovies.vercel.app/movies/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://watchonlinemovies.vercel.app/movies/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section | Watch Online Movies™</title>
        <link rel='canonical' href='https://watchonlinemovies.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section | Watch Online Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://watchonlinemovies.vercel.app/movies' />
