  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel='canonical'
          href='https://watchonlinemovies.vercel.app/intro/contact'
        />
        ...
        <meta
          property='og:url'
          content='https://watchonlinemovies.vercel.app/intro/contact/'
        />
          ...
          <div className='flex flex-wrap'>
            <div className='grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6'>
              ...
              <p className='text-gray-500 mb-6'>
                ...
                related to Watch Online Movies?. We welcome your input to help us
                echance our services and offerings.
              </p>

              <p className='text-gray-500 mb-6'>
                To submit your email the following details to{' '}
                <strong>Watch Online Movies?@outlook.com</strong>:
              </p>
            </div>
