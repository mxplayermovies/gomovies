...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://watchonlinemovies.vercel.app/page4',
  headline: 'movies Section | Watch Online Movies™',
  url: 'https://watchonlinemovies.vercel.app/page4',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://watchonlinemovies.vercel.app/page4'
    }
  ]
})
...
const page4 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 4 | Watch Online Movies™</title>
        <link rel='canonical' href='https://watchonlinemovies.vercel.app/page4' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 4 | Watch Online Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://watchonlinemovies.vercel.app/page4' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://watchonlinemovies.vercel.app/moviesp3.json')
