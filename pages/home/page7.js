...
const page7 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://watchonlinemovies.vercel.app/page7',
    headline: 'movies Section | Watch Online Movies™',
    url: 'https://watchonlinemovies.vercel.app/page7',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://watchonlinemovies.vercel.app/page7'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 7 | Watch Online Movies™</title>
        <link rel='canonical' href='https://watchonlinemovies.vercel.app/page7' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 7 | Watch Online Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://watchonlinemovies.vercel.app/page7' />
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://watchonlinemovies.vercel.app/moviesp6.json');
