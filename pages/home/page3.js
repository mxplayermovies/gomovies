...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://watchonlinemovies.vercel.app/page3',
  headline: 'movies Section | Watch Online Movies™',
  url: 'https://watchonlinemovies.vercel.app/page3',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://watchonlinemovies.vercel.app/page3'
    }
  ]
})
...
const page3 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 3 | Watch Online Movies™</title>
        <link rel='canonical' href='https://watchonlinemovies.vercel.app/page3' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 3 | Watch Online Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://watchonlinemovies.vercel.app/page3' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://watchonlinemovies.vercel.app/moviesp2.json')
