...
const page7 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 8 | Watch Online Movies™</title>
        ...
        <meta property='og:title' content=' Main Section 8 | Watch Online Movies™' />
        <meta
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://watchonlinemovies.vercel.app/moviesp7.json');
