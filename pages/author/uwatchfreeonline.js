...
export default function WatchMoviesOnline ({ movie }) {
    ...
    const handleSearch = (event) => {
        ...
        if (searchTermLower.includes('tv show')) {
            searchURL = `https://www.google.com/search?q=site:https://watchonlinemovies.vercel.apptvshow/${encodeURIComponent(searchTermLower)}-2024`;
        } else {
            searchURL = `https://www.google.com/search?q=site:https://watchonlinemovies.vercel.appmovie/${encodeURIComponent(searchTermLower)}-2024`;
        }
                    ...
                    dangerouslySetInnerHTML={{
                        __html: `{
                            ...
                            "@graph": [
                                ...
                                {
                                    "@type": "ProfilePage",
                                    "@id": "https://watchonlinemovies.vercel.appauthor/watchmoviesonline/#webpage",
