...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
  <h2 className="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
    ...
    <Image className="scale-100 hover:scale-110 ease-in duration-500 cursor-pointer rounded-3xl blur-invert  drop-shadowrounded-3xl"  src='https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681609999/darji-2022_enxhpi.webp' alt='DARJI - 2023'  width={1000}  height={562.5}  loading="lazy"/>
